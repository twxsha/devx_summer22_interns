      ...
      <div className="About" id="About">
        <div className="textWrapperLeft">
          ...
          <p className="p1" data-aos="fade-down" data-aos-delay="150">
            Ever feel like what you learn in the classroom is deeply
            theoretical, with little opportunities to build out practical
            applications?
          </p>
          <p className="p1" data-aos="fade-down" data-aos-delay="300">
            DevX is a student organization dedicated to solving that very
            problem! We comprise of several project teams building out
            real-world projects to help tackle pressing problems frustrating the
            UCLA community. Make your ideas come to life, grow your technical
