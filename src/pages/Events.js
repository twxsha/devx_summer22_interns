      ...
      <div className="section">
        <div className="Events" id="Events">
            ...
            <div className="calendar" id="cal" data-aos="fade-down" data-aos-delay="0">
              <div className = "responsive" dangerouslySetInnerHTML={{ __html: "<iframe src='https://calendar.google.com/calendar/embed?src=ucladevx%40gmail.com&ctz=America%2FLos_Angeles' width='1200px' height='800px' style='border: 25px solid #5DABAA;' />"}} />;
            </div>
